...
|--------------------------------------------------------------------------------------|-------------------------------------|-----------------|----------------------------------|----------------------------------------|--------------------------------|--------------------------------------|------------------------------------------------------------------------------|
| `{"event_type": "noop", "event_ts": 1729794114937000}`                               | null                                | non-null        | null                             | `noop`                                 | null                           | 1729794114937000                     | Fully shredded object                                                        |
| `{"event_type": "login", "event_ts": 1729794146402000, "email": "user@example.com"}` | `{"email": "user@example.com"}`     | non-null        | null                             | `login`                                | null                           | 1729794146402000                     | Partially shredded object                                                    |
...
| `{"event_ts": 1729794240241000, "click": "_button"}`                                 | `{"click": "_button"}`              | non-null        | null                             | null                                   | null                           | 1729794240241000                     | Field `event_type` is missing                                                |
| `{"event_type": null, "event_ts": 1729794954163000}`                                 | null                                | non-null        | `00` (field exists, is null)     | null                                   | null                           | 1729794954163000                     | Field `event_type` is present and is null                                    |
...
| INVALID: `{"event_type": "login", "event_ts": 1729795057774000}`                     | `{"event_type": "login"}`           | non-null        | null                             | `login`                                | null                           | 1729795057774000                     | INVALID: Shredded field is present in `value`                                |
