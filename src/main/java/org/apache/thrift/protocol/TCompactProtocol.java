 ...
 *
 * This particular copy of the TCompactProtocol class is verbatim from 0.7.0 with one small change:
 * the class is no longer final, so it can be changed as needed through inheritance.
 */
